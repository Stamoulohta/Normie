...
#define STRING_CONFIG_H_AUTHOR "(Stamoulohta, Normie config)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Normie"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3200, 1380 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, 3, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
